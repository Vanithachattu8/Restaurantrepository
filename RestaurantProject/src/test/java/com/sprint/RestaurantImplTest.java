...
public class RestaurantImplTest {
    ...
    public void testCreateRestaurant() {
        ...
        @Test
        public void testGetTablesBySeating() throws TableNotFoundException {
        ...
        @Test
        public void testGetAllAvailableTables() {
            List<Restaurant> tables = new ArrayList<>();
            tables.add(new Restaurant());
            tables.add(new Restaurant());
        ...
        @Test
        public void testGetTablesAvailableOnDateTime() throws TableNotFoundException {
